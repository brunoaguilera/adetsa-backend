...
public class LotteryInvocationException extends BusinessException {
	...
	public LotteryInvocationException(String errorCode, String message) {
		super(errorCode, message);
	}

	public LotteryInvocationException(String offendingField, FIELDS_POSSIBLE_ERRORS fieldErrorType, String message) {
	...
	public LotteryInvocationException(GenericMessageKey messageKey) {
		super(messageKey.getKey(), messageKey.getDesc());
	}

	public LotteryInvocationException(GenericMessageKey messageKey, String msg) {
