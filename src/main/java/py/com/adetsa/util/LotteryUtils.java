...
public class LotteryUtils {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(LotteryUtils.class);
	...
	public static String trim(String value) {
		value = nvl(value, "");
		return ("".equals(value.trim()) ? "" : value.trim());
	}
	...
	/**
	 * Usemos Math.random() para generar un número aleatorio dentro de un rango
	 * específico mientras excluimos algunos valores:
	 */
	...
	/**
	 * Aquí, creamos una nueva instancia de Random e invocamos el método nextInt()
	 * para generar un número aleatorio dentro de un rango específico con algunas
	 * exclusiones.
	 */
	...
	public static double getBottomValue(double firstRandom, double secondRandom) {
		return (firstRandom >= secondRandom ? secondRandom : firstRandom);
	}

	public static double getHighestValue(double firstRandom, double secondRandom) {
